...
import {
  Configuration,
  ValidModeRule,
} from "@rapidkey/schemas/configuration";
import {
  LeaderboardEntry,
...
import { getCurrentDayTimestamp } from "@rapidkey/util/date-and-time";

const dailyLeaderboardNamespace = "rapidkey:dailyleaderboard";
