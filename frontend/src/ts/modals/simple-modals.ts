...
import { CustomThemeColors } from "@rapidkey/schemas/configs";
...
import { GenerateDataRequest } from "@rapidkey/contracts/dev";
import {
  PasswordSchema,
  UserEmailSchema,
  UserNameSchema,
} from "@rapidkey/schemas/users";
...
list.removePasswordAuth = new SimpleModal({
  ...
  inputs: [
    {
      type: "checkbox",
      label: `I understand I will lose access to my RapidKey account if my Google/GitHub account is lost or disabled.`,
    },
  ],
  onlineOnly: true,
